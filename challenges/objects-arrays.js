...
zooAnimals.forEach(animal => {
  const animalAndScientificNames = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`

  return displayNames.push(animalAndScientificNames);
});
...
const lowCaseAnimalNames = zooAnimals.map(animal => animal.animal_name.toLocaleLowerCase());
